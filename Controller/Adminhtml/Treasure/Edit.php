...
namespace Streak\Treasure\Controller\Adminhtml\treasure;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Streak_Treasure::Treasure')
            ->addBreadcrumb(__('Streak Treasure'), __('Streak Treasure'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('treasure', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->setActiveMenu('Streak_Treasure::treasure');
        $resultPage->addBreadcrumb(__('Streak'), __('Streak'));
